                            ...
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="page-header">
                                        <h2 class="pageheader-title"><?php echo ($message); ?>, <?php echo $row['username']; ?> </h2> <?php } ?>
                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                <li class="breadcrumb-item"><a href="dashboard.php" class="breadcrumb-link">Dashboard</a></li>
                                                <li class="breadcrumb-item active" aria-current="page">Total Dine-In Orders</li>
                                            </ol>
                                        </nav>
                                    </div>
                                    </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="panel-body">
                                                ...
                                                <form role="form" method="post" action="weekly-menu-reports-detailed.php">
