                  ...
                  <div class="page-header">
                     ...
                     <div class="page-breadcrumb">
                        ...
                        <ol class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item active" aria-current="page">View Takeout Orders</li>
                                            </ol>
                        </nav>
                     </div>
                  </div>
                                       ...
                                       <tr  class="table-row1" style="font-size:large;color: black !important;background-color:white !important;">
                                        ...
                                        <td>
                                            ...
                                            if (!empty($data[0 + $step])) {
                                                $stmtOrder = "SELECT COUNT(*) AS totalOrder FROM pickups WHERE diningdate = '" . $data[0 + $step]['dd'] . "' AND dishname = '" . $data[0 + $step]['d1'] . "'";
                                        ...
                                        <td>
                                            ...
                                            if (!empty($data[1 + $step])) {
                                                $stmtOrder = "SELECT COUNT(*) AS totalOrder FROM pickups WHERE diningdate = '" . $data[1 + $step]['dd'] . "' AND dishname = '" . $data[1 + $step]['d1'] . "'";
                                                $sqlOrder = mysqli_query($con, $stmtOrder);
                                                $dataOrder = mysqli_fetch_all($sqlOrder, MYSQLI_ASSOC);
                                                if(empty($dataOrder[0]['totalOrder'])) {
                                                    echo '<span style="color:#008000">No order yet</span>';
                                        ...
                                        <td>
                                            ...
                                            if (!empty($data[2 + $step])) {
                                                $stmtOrder = "SELECT COUNT(*) AS totalOrder FROM pickups WHERE diningdate = '" . $data[2 + $step]['dd'] . "' AND dishname = '" . $data[2 + $step]['d1'] . "'";
                                                $sqlOrder = mysqli_query($con, $stmtOrder);
                                                $dataOrder = mysqli_fetch_all($sqlOrder, MYSQLI_ASSOC);
                                                if(empty($dataOrder[0]['totalOrder'])) {
                                                    echo '<span style="color:#008000">No order yet</span>';
                                        ...
                                        <td>
                                            ...
                                            if (!empty($data[3 + $step])) {
                                                $stmtOrder = "SELECT COUNT(*) AS totalOrder FROM pickups WHERE diningdate = '" . $data[3 + $step]['dd'] . "' AND dishname = '" . $data[3 + $step]['d1'] . "'";
                                                $sqlOrder = mysqli_query($con, $stmtOrder);
                                                $dataOrder = mysqli_fetch_all($sqlOrder, MYSQLI_ASSOC);
                                                if(empty($dataOrder[0]['totalOrder'])) {
                                                    echo '<span style="color:#008000">No order yet</span>';
                                        ...
                                        <td>
                                            ...
                                            if (!empty($data[4 + $step])) {
                                                $stmtOrder = "SELECT COUNT(*) AS totalOrder FROM pickups WHERE diningdate = '" . $data[4 + $step]['dd'] . "' AND dishname = '" . $data[4 + $step]['d1'] . "'";
                                                $sqlOrder = mysqli_query($con, $stmtOrder);
                                                $dataOrder = mysqli_fetch_all($sqlOrder, MYSQLI_ASSOC);
                                                if(empty($dataOrder[0]['totalOrder'])) {
                                                    echo '<span style="color:#008000">No order yet</span>';
                                       ...
                                       <tr class="table-row1" style="font-size:large;color: black !important;background-color:white !important;">
                                        ...
                                        <tr style="font-size:large;color: black !important;background-color:white !important;">
                                            ...
                                            <td>
                                                <?php
                                                if (!empty($data[0 + $step])) {
                                                    $stmtOrder = "SELECT COUNT(*) AS totalOrder FROM pickups WHERE diningdate = '" . $data[0 + $step]['dd'] . "' AND dishname = '" . $data[0 + $step]['d2'] . "'";
                                                    $sqlOrder = mysqli_query($con, $stmtOrder);
                                                    $dataOrder = mysqli_fetch_all($sqlOrder, MYSQLI_ASSOC);
                                                    if(empty($dataOrder[0]['totalOrder'])) {
                                                        echo '<span style="color:#008000">No order yet</span>';
                                            ...
                                            <td>
                                                <?php
                                                if (!empty($data[1 + $step])) {
                                                    $stmtOrder = "SELECT COUNT(*) AS totalOrder FROM pickups WHERE diningdate = '" . $data[1 + $step]['dd'] . "' AND dishname = '" . $data[1 + $step]['d2'] . "'";
                                                    $sqlOrder = mysqli_query($con, $stmtOrder);
                                                    $dataOrder = mysqli_fetch_all($sqlOrder, MYSQLI_ASSOC);
                                                    if(empty($dataOrder[0]['totalOrder'])) {
                                                        echo '<span style="color:#008000">No order yet</span>';
                                            ...
                                            <td>
                                                <?php
                                                if (!empty($data[2 + $step])) {
                                                    $stmtOrder = "SELECT COUNT(*) AS totalOrder FROM pickups WHERE diningdate = '" . $data[2 + $step]['dd'] . "' AND dishname = '" . $data[2 + $step]['d2'] . "'";
                                                    $sqlOrder = mysqli_query($con, $stmtOrder);
                                                    $dataOrder = mysqli_fetch_all($sqlOrder, MYSQLI_ASSOC);
                                                    if(empty($dataOrder[0]['totalOrder'])) {
                                                        echo '<span style="color:#008000">No order yet</span>';
                                            ...
                                            <td>
                                                <?php
                                                if (!empty($data[3 + $step])) {
                                                    $stmtOrder = "SELECT COUNT(*) AS totalOrder FROM pickups WHERE diningdate = '" . $data[3 + $step]['dd'] . "' AND dishname = '" . $data[3 + $step]['d2'] . "'";
                                                    $sqlOrder = mysqli_query($con, $stmtOrder);
                                                    $dataOrder = mysqli_fetch_all($sqlOrder, MYSQLI_ASSOC);
                                                    if(empty($dataOrder[0]['totalOrder'])) {
                                                        echo '<span style="color:#008000">No order yet</span>';
                                            ...
                                            <td>
                                                <?php
                                                if (!empty($data[4 + $step])) {
                                                    $stmtOrder = "SELECT COUNT(*) AS totalOrder FROM pickups WHERE diningdate = '" . $data[4 + $step]['dd'] . "' AND dishname = '" . $data[4 + $step]['d2'] . "'";
                                                    $sqlOrder = mysqli_query($con, $stmtOrder);
                                                    $dataOrder = mysqli_fetch_all($sqlOrder, MYSQLI_ASSOC);
                                                    if(empty($dataOrder[0]['totalOrder'])) {
                                                        echo '<span style="color:#008000">No order yet</span>';
