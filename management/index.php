...
if (isset($_POST['login'])) {
    ...
    $query = mysqli_query($con, "SELECT * FROM management WHERE username='$username' and password='$password'");
    ...
    <div class="splash-container">
        <div class="card ">
            <div class="card-header text-center"><a href="index.php">
                    <h1>Silver Glen</h1>
                </a><span class="splash-description"> <span style="color:darkcyan">MANAGEMENT</span> </br> Please enter your credentials.</span></div>
            <div class="card-body">
                <form method="post">
