...
$id=intval($_GET['id']);
$query=mysqli_query($con,"select * from pickups where id='$id'");
while($row=mysqli_fetch_array($query))
{
$memprice = $row['membermealprice'];
$memtax = $row['membermealtaxvalue'];

$subtotal = $memprice + $memtax;
$totaltax = $memtax;
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td style="font-size: 12px; color: #5b5b5b; font-family: 'Open Sans', sans-serif; line-height: 18px; vertical-align: top; text-align: right;">
                            <small>Takeout ID</small> #<?php echo  htmlentities($row['bookingid']);?><br />
                ...
                <table width="480" border="0" cellpadding="0" cellspacing="0" align="center" class="fullPadding">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #000; line-height: 22px; vertical-align: top; text-align:right; ">
                        <strong>$<?php echo  htmlentities($grandtotal);?></strong>
                      </td>
                    </tr>
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #5b5b5b; line-height: 20px; vertical-align: top; ">
                                Silver Glenn<br> 1750 152nd Ave NE<br> Bellevue, WA<br> 98007, United States<br> T: 425-957-1032
                              </td>
                            </tr>
                          </tbody>
                        </table>
