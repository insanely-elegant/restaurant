...
if (isset($_POST['submit'])) {
    ...
    $id = intval($_GET['id']);
    $sql = mysqli_query($con, "update staff set firstname='$firstname',lastname='$lastname',age='$age',unitno='$unitno',contactno='$contactno'
,altcontactno='$altcontactno',email='$email',password='$password' where id='$id'");
    $_SESSION['msg'] = "Staff Profile Updated !!";
    echo "<meta http-equiv='refresh' content='1;url=create-staff.php'/>";
}

if (isset($_GET['del'])) {
    mysqli_query($con, "delete from staff where id = '" . $_GET['id'] . "'");
    $_SESSION['delmsg'] = "Staff Account & Staff Profile deleted !!";
}
                                    ...
                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item active" aria-current="page">Update Staff Profile & Account</li>
                                            </ol>
                                        </nav>
                                    </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="section-block" id="basicform">
                                        <h3 class="section-title">Update Staff Profile & Account</h3>
                                        <p>You can edit the staff account here</p>
                                            ...
                                            <form method="post">
                                                ...
                                                ?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input name="unitno" value="<?php echo  htmlentities($row['unitno']); ?>" type="text" class="form-control">
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <button type="submit" name="submit" class="btn btn-outline-dark">Update Staff Profile</a>
                                            </form> <?php } ?>
                                        </div>
