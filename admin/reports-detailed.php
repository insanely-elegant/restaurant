                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <br/><br/>
                                                ...
                                                <div class="table-responsive">
                                                    <table id="dining_report" class="table table-striped table-bordered second" style=" width:100%">
                                                        <thead>
                                                            <tr>
                                                                <th class="center">#</th>
                                                                <th>First Name</th>
...
//                              $LinkMap[0] = 'receipt-guest.php';
                                                            while ($row = mysqli_fetch_array($sql)) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><?php
                                                                        ...
                                                                        ?></td>
                                                                    <td><?php
                                                                        if ($row['guestmealtotalprice'] != NULL) {
                                                ...
                                                <?php echo "membermealtotal:" . $total['membermealtotal']; ?>
                                                <?php echo "membermealtaxvalue:" . $total['membermealtaxvalue']; ?>
