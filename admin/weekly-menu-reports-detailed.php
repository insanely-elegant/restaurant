...
$sql=mysqli_query($con,"SELECT weeklymenu.id as wid, weeklymenu.diningdate as dd, weeklymenu.diningtime as dt, 
weeklymenu.dishname1 as d1, weeklymenu.dishname2 as d2,weeklymenu.roomid as rid, room.id as roomid, room.roomname as rname
