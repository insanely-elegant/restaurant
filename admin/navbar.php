...
<div class="nav-left-sidebar sidebar-dark" >
    <div class="menu-list">
        <nav class="navbar navbar-expand-lg navbar-light" style="overflow:scroll">
                ...
                <ul class="navbar-nav flex-column">
                    ...
                    <li class="nav-item">
                        ...
                        <div id="submenu-13" class="collapse submenu" style="">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link" href="dining-reports.php">.</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="dining-reports-with-unitno.php">.</a>
                                </li>
                            </ul>
                        </div>
                    </li>
