                                            ...
                                            <div class="panel-body">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <h5 align="center" style="color:blue">Weekly Menu from current week.</h5> </br>
                                                        <div id="printTable">
                                                        
                                                        <table class="table table-striped table-hover table-bordered table-responsive" id="sample-table-1">
                                                            <caption style="font-size:large;color:black !important;"> Weekly Menu from current week </caption>
