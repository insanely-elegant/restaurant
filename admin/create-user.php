                            ...
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="section-block" id="basicform">
                                        ...
                                        <p>You can create the user account here</p>
                                        ...
                                        <div class="card-body">
                                            <form method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input name="unitno" type="text" onBlur="userAvailability()" class="form-control" id="unitno" required>
                                                ...
                                                <button type="submit" name="submit" class="btn btn-outline-dark" id="submit">Create User</a>
                                            </form>
                                        </div>
