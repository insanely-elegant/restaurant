                                    ...
                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item active" aria-current="page">Takeout Menu</li>
                                            </ol>
                                        </nav>
                                    </div>
                                    </div>
                                            ...
                                            <div class="panel-body">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        ?>
                                                        <h5 align="center" style="color:blue">Takeout Menu from <?php echo $fdate ?> to <?php echo $tdate ?></h5> </br>
                                                        ...
                                                        <table class="table table-hover" id="sample-table-1">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                $sql = mysqli_query($con, "SELECT DISTINCT pickupdate,pickuptime,dishname1,dishname2 from pickupweeklymenu WHERE 
                                                                pickupdate >= '$fdate' AND pickupdate <= '$tdate'");
                                                                $cnt = 1;
                                                                while ($row = mysqli_fetch_array($sql)) {
                                                                ?>
                                                                    <tr>
                                                                        <td class="center"><?php echo $cnt; ?>.</td>
                                                                        <td class="hidden-xs"><?php echo $row['pickupdate']; ?></td>
                                                                        <td class="hidden-xs"><?php echo $row['pickuptime']; ?></td>
                                                                        <td><?php echo $row['dishname1']; ?></td>
                                                                        <td><?php echo $row['dishname2']; ?>
                                                                        </td>
                                                                        <td>
                                                                        </td>
                                                                    </tr>
