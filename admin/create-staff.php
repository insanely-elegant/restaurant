...
if (isset($_POST['submit'])) {
    ...
    $sql = mysqli_query($con, "insert into staff(firstname,lastname,age,unitno,contactno,altcontactno,email,password) values('$firstname','$lastname','$age',
'$unitno','$contactno','$altcontactno','$email','$password')");
    $_SESSION['msg'] = "New Staff Profile & Staff Account Created !!";
}

if (isset($_GET['del'])) {
    mysqli_query($con, "delete from staff where id = '" . $_GET['id'] . "'");
    $_SESSION['delmsg'] = "Staff Profile & Account deleted !!";
}
                            ...
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="section-block" id="basicform">
                                        <h3 class="section-title">Create Staff Accounts & Staff Profile </h3>
                                        <p>You can create the Staff account here</p>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <form method="post">
                                                ...
                                                <div class="form-group">
                                                    <label for="inputText3" class="col-form-label">Unit Number ( If Applicable )</label>
                                                    <input name="unitno" type="text" class="form-control" id="unitno">
                                                ...
                                                <button type="submit" name="submit" class="btn btn-outline-dark" id="submit">Create Staff</a>
                                            </form>
                                        </div>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="edit-staff.php?id=<?php echo $row['id'] ?>" class="btn btn-sm btn-outline-light">Edit</button>
                                                                <a href="create-staff.php?id=<?php echo $row['id'] ?>&del=delete" onClick="return confirm('Are you sure you want to delete?')" class="btn btn-sm btn-outline-light">
