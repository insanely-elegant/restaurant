									...
									<div class="row">
										<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
											<div class="section-block" id="basicform">
												<h3 class="section-title">Weekly Takeout Menu</h3>
												</br>
											</div>
													...
													<div class="panel-body">
														<div class="row">
															<div class="col-md-12">
																...
																?>
																<h5 align="center" style="color:blue">Weekly Takeout Menu from <?php echo $fdate ?> to <?php echo $tdate ?></h5> </br>
																...
																<table class="table table-striped table-hover table-bordered table-responsive" id="sample-table-1">
																	...
																	?>
																		<thead style="background-color:#154e84;">
																			<tr>
																				<th colspan="6" style="font-size:x-large;text-align: center;color: white;background-color: black;">Weekly Takeout Menu </th>
